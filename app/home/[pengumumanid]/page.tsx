    ...
    <>
      ...
      <div className="flex flex-col items-center w-full h-full pt-16">
        <div className="flex flex-col w-full h-screen px-12">
          <div className="w-full h-fit p-2 bg-white rounded-lg hover:cursor-default" style={{ border: '3px solid #2D517B' }}>
                ...
                {pengumuman.files.map((file, index) => (
                  <div key={index}>
                    <button
                      ...
                      onClick={() => handleDownload(file.file, file.original_name)}
                    >
                      <FaAngleRight />
                      {file.original_name}
                    </button>
          ...
          {/* comments */}
          <div className="w-full h-fit my-4 pl-8 pr-4 py-2 bg-white rounded-lg hover:cursor-default" style={{ border: '3px solid #2D517B' }}>
            ...
            <div className="flex flex-col gap-4">
              {comments.map((data) => (
                <div
                  ...
                  style={{ border: data.id === openEditComment?.reply_id ? '3px solid #2D517B' : '1px solid #ddd' }}
                >
                  <div className="flex flex-row items-center gap-2 text-sm justify-between">
